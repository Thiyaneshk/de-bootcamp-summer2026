...
def test_load_prices_invalid_symbol(mock_download):
    ...
    df = load_prices_daily('INVALID_SYMBOL', start_date='2026-05-01', end_date='2026-05-02')
...
def test_prices_dataframe_structure():
    ...
    assert all(col in ['Open', 'High', 'Low', 'Close', 'Volume', 'Adj Close'] for col in expected_cols)
